...
var params72 = []string{
	...
	"-logfn", "/home/dbarbera/Data/test_cases/allowed1_philip/Temp_990ba583-5249-41f3-8d42-0617f9eea6cd/log/d0c65f23-d9cc-4047-8f3c-3a91db3623ff_2668db47_frate_72_from_go_XYZ-PLUS.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
...
var batch_params72 = string[]{
	...
	"-beam", "1e-10000",
	"-bestpath", "no",
	"-cepdir", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/audio",
	"-cepext", ".wav",
	"-ctl", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/ctl/ctl_allowed1_philip_fixed_trimmed.txt",
	"-dict", "/home/dbarbera/Repositories/pronounce-experimental/Dictionaries/art_db_v2_inference.phone",
	"-dither", "yes",
	"-doublebw", "yes",
	"-frate", "72",
	"-fwdflat", "no",
	"-hmm", "/usr/local/share/xyzpocketsphinx/model/art-en-us/en-us",
	"-logfn", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/log/7eb4a3dd-1fb5-4e64-b7f9-fb3cbbca5829_-frate_72_BATCH_xyz_plus.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
...
var batch_params80 = string[]{
	...
	"-fwdflat", "no",
	"-hmm", "/usr/local/share/xyzpocketsphinx/model/art-en-us/en-us",
	"-logfn", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/log/7eb4a3dd-1fb5-4e64-b7f9-fb3cbbca5829_-frate_80_BATCH_xyz_plus.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
...
var batch_params91 = string[]{
	...
	"-fwdflat", "no",
	"-hmm", "/usr/local/share/xyzpocketsphinx/model/art-en-us/en-us",
	"-logfn", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/log/7eb4a3dd-1fb5-4e64-b7f9-fb3cbbca5829_-frate_91_BATCH_xyz_plus.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
...
var batch_params105 = string[]{
	...
	"-fwdflat", "no",
	"-hmm", "/usr/local/share/xyzpocketsphinx/model/art-en-us/en-us",
	"-logfn", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/log/7eb4a3dd-1fb5-4e64-b7f9-fb3cbbca5829_-frate_105_BATCH_xyz_plus.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
...
var batch_params125 = string[]{
	...
	"-fwdflat", "no",
	"-hmm", "/usr/local/share/xyzpocketsphinx/model/art-en-us/en-us",
	"-logfn", "/home/dbarbera/Data/test_cases_better/allowed1_philip_allowed/log/7eb4a3dd-1fb5-4e64-b7f9-fb3cbbca5829_-frate_125_BATCH_xyz_plus.log",
	"-lpbeam", "1e-10000",
	"-lponlybeam", "1e-10000",
	"-lw", "6",
	"-maxhmmpf", "-1",
